...
def Args():
    ...
    P_filter.add_argument("-sp", "--simplerepeat", type=str, 
    ...
    P_Circos = subparsers.add_parser('Circos',conflict_handler='resolve',
                    formatter_class=argparse.ArgumentDefaultsHelpFormatter,
                    parents=[P_Common, P_merge, P_update, P_filter, P_circos],
    ...
    P_Autopipe = subparsers.add_parser('Auto', conflict_handler='resolve', prefix_chars='-+',
                    formatter_class=argparse.ArgumentDefaultsHelpFormatter,
                    parents=[P_Common, P_fetch, P_search, P_merge, P_update, P_filter, P_circos, P_check],
                    help='the auto-processing for all.')
    P_Autopipe.add_argument("+P", "++pipeline", nargs='+', default=['Update', 'Filter', 'Circos'],
